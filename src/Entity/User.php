...
class User
{
     ...
     * @ORM\ManyToOne(targetEntity="AclAdmin\Entity\Role", inversedBy="users", fetch="EAGER")
     ...
     * @return User
     */
    public function setRole(\AclAdmin\Entity\Role $role = null)
    {
        $this->role = $role;
